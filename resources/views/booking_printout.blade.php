...
<head>
  ...
  <style>
    ...
    @media print {
      @page {
        size: A4 portrait;
        margin: 0.5cm; /* Consistent 0.5cm margin for printing */
      }
      body {
        width: 100%;
        height: 100%;
      ...
      .terms-columns { column-count: 2; column-gap: 15px; }
...
<body>
  ...
  <div class="wrap">
    ...
    <div class="wifi-info">
      <span style="color: red; font-size: 1.5rem; font-weight: bold;">ID:{{ substr($order->formated_code, -3) }}</span><br>
  ...
  <div class="wrap">
    ...
    <div class="wifi-info">
      <span style="color: red; font-size: 1.5rem; font-weight: bold;">ID:{{ substr($order->order_code, -3) }}</span><br>
      PASSWORD WIFI ATAS: nginapdulu<br>
      Gedung belakang: nadikaguestb2025
    </div>
